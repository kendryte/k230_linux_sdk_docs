...
| K230 Linux SDK | V0.6.0 | 2024-11-30 |
| K230 Linux SDK | V0.6.1 | 2024-12-06 |
...
| 7 | V0.6.0 | 低速驱动 | 添加Tsensor、SPI、wdt、adc、pwm、RTC驱动 | |
| 8 | V0.6.0 | DRM | Display支持旋转 | |
| 9 | V0.6.0 | HDMI | 支持1080P 720P | |
| 10 | V0.6.0 | opencv | vector加速opencv | |
...
| 45 | V0.6.0 | demo串烧 | 集成手势关键点识别、动态手势识别、人脸姿态角和单目标跟踪等来智能跟踪拍摄车 | |
| 46 | V0.6.0 | OCR识别 | 检测到图像或视频中的文本位置以及相应的文字内容 | |

## 5. 版本的遗留问题及限制说明

| ID | 功能模块 | 问题/限制描述 | 备注 |
| --- | --- | --- | --- |
| 1 | ISP | 采集sensor的图像经过ISP处理后有明显噪点 |  |
